...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_Graphics2_00024CppProxy_create(JNIEnv* jniEnv, jobject /*this*/, jint j_width, jint j_height, jboolean j_rTargets)
{
    try {
