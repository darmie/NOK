...
CJNIEXPORT jdouble JNICALL Java_co_zenturi_nok_Vec4_00024CppProxy_native_1getW(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::nok::Vec4>(nativeRef);
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_Vec4_create(JNIEnv* jniEnv, jobject /*this*/, jdouble j_x, jdouble j_y, jdouble j_z)
{
    try {
