...
CJNIEXPORT jint JNICALL Java_co_zenturi_nok_Image_sizeOf(JNIEnv* jniEnv, jobject /*this*/, jobject j_format)
{
    try {
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_Image_create(JNIEnv* jniEnv, jobject /*this*/, jint j_width, jint j_height, jobject j_format, jboolean j_readable)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_Image_create3D(JNIEnv* jniEnv, jobject /*this*/, jint j_width, jint j_height, jint j_depth, jobject j_format, jboolean j_readable)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_Image_fromData(JNIEnv* jniEnv, jobject /*this*/, jbyteArray j_data, jint j_width, jint j_height, jobject j_format, jboolean j_readable)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_Image_fromData3D(JNIEnv* jniEnv, jobject /*this*/, jbyteArray j_data, jint j_width, jint j_height, jint j_depth, jobject j_format, jboolean j_readable)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
