...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_VertexElement_00024CppProxy_create(JNIEnv* jniEnv, jobject /*this*/)
{
    try {
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_VertexElement_00024CppProxy_createWithName(JNIEnv* jniEnv, jobject /*this*/, jstring j_name, jobject j_data)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_VertexElement_00024CppProxy_createWithAttribute(JNIEnv* jniEnv, jobject /*this*/, jobject j_attribute, jobject j_data)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
