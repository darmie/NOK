...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_RenderTarget_create(JNIEnv* jniEnv, jobject /*this*/, jint j_width, jint j_height, jint j_depthBufferBits, jboolean j_antialiasing, jobject j_format, jint j_stencilBufferBits, jint j_contextId)
{
    try {
...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_RenderTarget_createCube(JNIEnv* jniEnv, jobject /*this*/, jint j_cubeMapSize, jint j_depthBufferBits, jboolean j_antialiasing, jobject j_format, jint j_stencilBufferBits, jint j_contextId)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
