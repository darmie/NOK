...
CJNIEXPORT jobject JNICALL Java_co_zenturi_nok_VertexBuffer_create(JNIEnv* jniEnv, jobject /*this*/, jint j_count, jobject j_structure, jobject j_usage, jint j_instanceDataStepRate)
{
    try {
