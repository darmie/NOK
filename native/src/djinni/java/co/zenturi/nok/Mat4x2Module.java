...
@ReactModule(name = "Mat4x2Module")
public final class Mat4x2Module extends ReactContextBaseJavaModule {
    ...
    public Mat4x2Module(ReactApplicationContext reactContext) {
        super(reactContext);
