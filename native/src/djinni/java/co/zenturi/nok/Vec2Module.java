...
@ReactModule(name = "Vec2Module")
public final class Vec2Module extends ReactContextBaseJavaModule {
    private final CppProxy mModule;

    public Vec2Module(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    @ReactMethod
    public void getXy(Promise promise) {
        mModule.getXy(ReactDjinni.wrap(promise));
    }
    ...
    private static final class CppProxy
    {
        ...
        public void getXy(com.rushingvise.reactcpp.JavascriptPromise promise)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_getXy(this.nativeRef, promise);
        }
        private native void native_getXy(long _nativeRef, com.rushingvise.reactcpp.JavascriptPromise promise);
