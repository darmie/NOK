...
@ReactModule(name = "Mat3x4Module")
public final class Mat3x4Module extends ReactContextBaseJavaModule {
    ...
    public Mat3x4Module(ReactApplicationContext reactContext) {
        super(reactContext);
