...
@ReactModule(name = "Mat2x4Module")
public final class Mat2x4Module extends ReactContextBaseJavaModule {
    ...
    public Mat2x4Module(ReactApplicationContext reactContext) {
        super(reactContext);
