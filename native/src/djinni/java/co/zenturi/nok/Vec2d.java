...
public abstract class Vec2d {
    ...
    public abstract void add(Vec2d v);

    public abstract void addScaledVector(Vec2d v);

    public abstract void sub(Vec2d v);
    ...
    public abstract Vec2d normalize();
    ...
    public abstract double dot(Vec2d v);

    public abstract Vec2d cross(Vec2d v);

    public abstract double distance(Vec2d v);
    ...
    private static final class CppProxy extends Vec2d
    {
        ...
        private native void native_add(long _nativeRef, Vec2d v);

        @Override
        public void addScaledVector(Vec2d v)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_addScaledVector(this.nativeRef, v);
        }
        private native void native_addScaledVector(long _nativeRef, Vec2d v);
        ...
        private native void native_sub(long _nativeRef, Vec2d v);
        ...
        private native Vec2d native_normalize(long _nativeRef);
        ...
        private native double native_dot(long _nativeRef, Vec2d v);
        ...
        private native Vec2d native_cross(long _nativeRef, Vec2d v);
        ...
        private native double native_distance(long _nativeRef, Vec2d v);
        ...
        public static native Vec2d create(double x, double y);
    }
}
