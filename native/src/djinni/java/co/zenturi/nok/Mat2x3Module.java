...
@ReactModule(name = "Mat2x3Module")
public final class Mat2x3Module extends ReactContextBaseJavaModule {
    ...
    public Mat2x3Module(ReactApplicationContext reactContext) {
        super(reactContext);
