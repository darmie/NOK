...
public abstract class VertexElement {
    ...
    public static VertexElement create()
    {
        return CppProxy.create();
    }

    public static VertexElement createWithName(String name, VertexData data)
    {
        return CppProxy.createWithName(name,
                                       data);
    }

    public static VertexElement createWithAttribute(VertexAttribute attribute, VertexData data)
    {
        return CppProxy.createWithAttribute(attribute,
                                            data);
    }
