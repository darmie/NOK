...
#import "NOKMat3Module+Private.h"
...
@interface NOKMat3Module ()

- (id)initWithCpp:(const std::shared_ptr<::nok::Mat3Module>&)cppRef;

@end

@implementation NOKMat3Module {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::nok::Mat3Module>> _cppRefHandle;
}
...
+ (nullable NOKMat3Module *)create:(nullable id<RVReactBridge>)bridge {
    try {
        auto objcpp_result_ = ::nok::Mat3Module::create(::djinni_generated::ReactBridge::toCpp(bridge));
        return ::djinni_generated::Mat3Module::fromCpp(objcpp_result_);
...
{
    return @{
        @"width": @(NOKMat3ModuleWidth),
        @"height": @(NOKMat3ModuleHeight),
    };
}

namespace djinni_generated {

auto Mat3Module::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto Mat3Module::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::get_cpp_proxy<NOKMat3Module>(cpp);
}
