...
#import "NOKMat3x4Module+Private.h"
...
@interface NOKMat3x4Module ()

- (id)initWithCpp:(const std::shared_ptr<::nok::Mat3x4Module>&)cppRef;

@end

@implementation NOKMat3x4Module {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::nok::Mat3x4Module>> _cppRefHandle;
}
...
+ (nullable NOKMat3x4Module *)create:(nullable id<RVReactBridge>)bridge {
    try {
        auto objcpp_result_ = ::nok::Mat3x4Module::create(::djinni_generated::ReactBridge::toCpp(bridge));
        return ::djinni_generated::Mat3x4Module::fromCpp(objcpp_result_);
...
{
    return @{
        @"width": @(NOKMat3x4ModuleWidth),
        @"height": @(NOKMat3x4ModuleHeight),
    };
}

namespace djinni_generated {

auto Mat3x4Module::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto Mat3x4Module::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::get_cpp_proxy<NOKMat3x4Module>(cpp);
}
