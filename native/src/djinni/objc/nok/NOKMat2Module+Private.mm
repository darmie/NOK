...
#import "NOKMat2Module+Private.h"
...
@interface NOKMat2Module ()

- (id)initWithCpp:(const std::shared_ptr<::nok::Mat2Module>&)cppRef;

@end

@implementation NOKMat2Module {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::nok::Mat2Module>> _cppRefHandle;
}
...
+ (nullable NOKMat2Module *)create:(nullable id<RVReactBridge>)bridge {
    try {
        auto objcpp_result_ = ::nok::Mat2Module::create(::djinni_generated::ReactBridge::toCpp(bridge));
        return ::djinni_generated::Mat2Module::fromCpp(objcpp_result_);
...
{
    return @{
        @"width": @(NOKMat2ModuleWidth),
        @"height": @(NOKMat2ModuleHeight),
    };
}

namespace djinni_generated {

auto Mat2Module::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto Mat2Module::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::get_cpp_proxy<NOKMat2Module>(cpp);
}
