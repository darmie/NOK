...
#import "NOKMat4x2Module+Private.h"
...
@interface NOKMat4x2Module ()

- (id)initWithCpp:(const std::shared_ptr<::nok::Mat4x2Module>&)cppRef;

@end

@implementation NOKMat4x2Module {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::nok::Mat4x2Module>> _cppRefHandle;
}
...
+ (nullable NOKMat4x2Module *)create:(nullable id<RVReactBridge>)bridge {
    try {
        auto objcpp_result_ = ::nok::Mat4x2Module::create(::djinni_generated::ReactBridge::toCpp(bridge));
        return ::djinni_generated::Mat4x2Module::fromCpp(objcpp_result_);
...
{
    return @{
        @"width": @(NOKMat4x2ModuleWidth),
        @"height": @(NOKMat4x2ModuleHeight),
    };
}

namespace djinni_generated {

auto Mat4x2Module::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto Mat4x2Module::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::get_cpp_proxy<NOKMat4x2Module>(cpp);
}
