...
#import "NOKMat4Module+Private.h"
...
@interface NOKMat4Module ()

- (id)initWithCpp:(const std::shared_ptr<::nok::Mat4Module>&)cppRef;

@end

@implementation NOKMat4Module {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::nok::Mat4Module>> _cppRefHandle;
}
...
+ (nullable NOKMat4Module *)create:(nullable id<RVReactBridge>)bridge {
    try {
        auto objcpp_result_ = ::nok::Mat4Module::create(::djinni_generated::ReactBridge::toCpp(bridge));
        return ::djinni_generated::Mat4Module::fromCpp(objcpp_result_);
...
{
    return @{
        @"width": @(NOKMat4ModuleWidth),
        @"height": @(NOKMat4ModuleHeight),
    };
}

namespace djinni_generated {

auto Mat4Module::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
...
auto Mat4Module::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::get_cpp_proxy<NOKMat4Module>(cpp);
}
