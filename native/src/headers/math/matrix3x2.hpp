...
{
template<class T>
class Matrix3x2 : public nok::Mat3, public nok::Mat3x2Module, public Kore::Matrix<3U, 2U, T>
{
private:
...
public:
    Matrix3x2() : nok::Mat3(), nok::Mat3x2Module(),  Kore::Matrix<3U, 2U, T>(){};
    Matrix3x2(Matrix3x2 *mat) : nok::Mat3(), nok::Mat3x2Module(), Kore::Matrix<3U, 2U, T>(*static_cast<Matrix3x2 *>(mat)){};
    ~Matrix3x2(){};

    Matrix3x2(const std::shared_ptr<::ReactBridge> &bridge) : nok::Mat3(), nok::Mat3x2Module(), Kore::Matrix<3U, 2U, T>()
    {
        this->mBridge = bridge;
    ...
    {
        auto nMat = std::make_shared<Matrix3x2<double>>(Matrix3x2::orthogonalProjection(left, right, bottom, top, zn, zf));
    ...
    {
        auto nMat = std::make_shared<Matrix3x2<double>>(Matrix3x2::perspective(left, right, top, bottom, near, far));
    ...
    {
        auto nMat = std::make_shared<Matrix3x2<double>>(Matrix3x2::perspectiveFOV(fov, aspect, near, far));
    ...
    static std::shared_ptr<Mat3> lookAt(const std::shared_ptr<Vec3> &eye, const std::shared_ptr<Vec3> &at, const std::shared_ptr<Vec3> &up)
    {
        ...
        return std::make_shared(static_cast<Matrix3x2 *>(Kore::Matrix<3U, 2U, T>::lookAt(nEye, nAt, nUp)));
    }
    ...
    void lookAt(const std::shared_ptr<::JavascriptMap> &eye, const std::shared_ptr<::JavascriptMap> &at, const std::shared_ptr<::JavascriptMap> &up, const std::shared_ptr<::JavascriptPromise> &promise)
    {
        ...
        auto nMat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::lookAt(nEye, nAt, nUp));
    ...
    static std::shared_ptr<Mat3> lookAlong(const std::shared_ptr<Vec3> &axis, const std::shared_ptr<Vec3> &eye, const std::shared_ptr<Vec3> &up)
    {
        ...
        return std::make_shared(static_cast<Matrix3x2 *>(Kore::Matrix<3U, 2U, T>::lookAlong(nAxis, nEye, nUp)));
    }
    ...
    void lookAlong(const std::shared_ptr<::JavascriptMap> &axis, const std::shared_ptr<::JavascriptMap> &eye, const std::shared_ptr<::JavascriptMap> &up, const std::shared_ptr<::JavascriptPromise> &promise)
    {
        ...
        auto nMat = std::make_shared<Matrix3x2<double>>(Matrix3x2::lookAlong(nAxis, nEye, nUp));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::translation(x, y));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::movement(x, y, z));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::identity());
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::scale(scale));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::rotationX(alpha));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::rotationY(alpha));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::rotationZ(alpha));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::rotation(yaw, pitch, roll));
    ...
    {
        auto xmat = Matrix3x2<double>::toNativeArray(mat);
        auto _mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::from(xmat));
    ...
    {
        auto xmat = Matrix3x2<double>::toNativeArray(mat);
        auto _mat = std::make_shared<Matrix3x2<double>>(this->add(xmat));
    ...
    {
        auto xmat = Matrix3x2<double>::toNativeArray(mat);
        auto _mat = std::make_shared<Matrix3x2<double>>(this->sub(xmat));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(this->multiply(i));
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(this->clone());
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(this->transpose());
    ...
    {
        auto mat = std::make_shared<Matrix3x2<double>>(this->transpose3x3());
    ...
    {
        auto _a = Matrix3x2<double>::toNative(a);
        auto _b = Matrix3x2<double>::toNative(b);

        auto mat = std::make_shared<Matrix3x2<double>>(Matrix3x2<double>::linearInterpolate(_a, _b, prop));
    ...
    inline std::shared_ptr<Matrix3x2> toNative(const std::shared_ptr<::JavascriptArray> &arr)
    {
        Kore::Matrix<3U, 2U, T> *nMat = static_cast<Kore::Matrix<3U, 2U, T>>(this);
        ...
        return std::make_shared<Matrix3x2>(static_cast<Matrix3x2 *>(nMat));
    }
};
