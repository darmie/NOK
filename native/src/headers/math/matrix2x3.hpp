...
class Matrix2x3 : public nok::Mat2, nok::Mat2x3Module, public Kore::Matrix<2U, 3U, T>
{
private:
...
public:
    Matrix2x3() : nok::Mat2(), nok::Mat2Module(), Kore::Matrix<2U, 3U, T>(){};
    Matrix2x3(Matrix2x3 *mat) : nok::Mat2(), nok::Mat2x3Module(), Kore::Matrix<2U, 3U, T>(*static_cast<Matrix2x3 *>(mat)){};
    ~Matrix2x3(){};

    static float const HEIGHT = 3;

    Matrix2x3(const std::shared_ptr<::ReactBridge> &bridge) : nok::Mat2(), nok::Mat2x3Module(), Kore::Matrix<2U, 3U, T>()
    {
        this->mBridge = bridge;
    ...
    static std::shared_ptr<Mat2x3Module> create(const std::shared_ptr<::ReactBridge> &bridge)
    {
        return std::make_shared<Matrix2x3>(bridge);
    }
    ...
    {
        auto nMat = std::make_shared<Matrix2x3<double>>(Matrix2x3::orthogonalProjection(left, right, bottom, top, zn, zf));
    ...
    {
        auto nMat = std::make_shared<Matrix2x3<double>>(Matrix2x3::perspective(left, right, top, bottom, near, far));
    ...
    static std::shared_ptr<Mat2> lookAt(const std::shared_ptr<Vec3> &eye, const std::shared_ptr<Vec3> &at, const std::shared_ptr<Vec3> &up)
    {
        ...
        return std::make_shared(static_cast<Matrix2x3 *> Kore::Matrix<2U, 3U, T>::lookAt(nEye, nAt, nUp));
    }
    ...
    void lookAt(const std::shared_ptr<::JavascriptMap> &eye, const std::shared_ptr<::JavascriptMap> &at, const std::shared_ptr<::JavascriptMap> &up, const std::shared_ptr<::JavascriptPromise> &promise)
    {
        ...
        auto nMat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::lookAt(nEye, nAt, nUp));
    ...
    static std::shared_ptr<Mat2> lookAlong(const std::shared_ptr<Vec3> &axis, const std::shared_ptr<Vec3> &eye, const std::shared_ptr<Vec3> &up)
    {
        ...
        return std::make_shared(static_cast<Matrix2x3 *> Kore::Matrix<2U, 3U, T>::lookAlong(nAxis, nEye, nUp));
    }
    ...
    void lookAlong(const std::shared_ptr<::JavascriptMap> &axis, const std::shared_ptr<::JavascriptMap> &eye, const std::shared_ptr<::JavascriptMap> &up, const std::shared_ptr<::JavascriptPromise> &promise)
    {
        ...
        auto nMat = std::make_shared<Matrix2x3<double>>(Matrix2x3::lookAlong(nAxis, nEye, nUp));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::translation(x, y));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::movement(x, y, z));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::identity());
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::scale(scale));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::rotationX(alpha));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::rotationY(alpha));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::rotationZ(alpha));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::rotation(yaw, pitch, roll));
    ...
    {
        auto xmat = Matrix2x3<double>::toNativeArray(mat);
        auto _mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::from(xmat));
    ...
    {
        auto xmat = Matrix2x3<double>::toNativeArray(mat);
        auto _mat = std::make_shared<Matrix2x3<double>>(this->add(xmat));
    ...
    {
        auto xmat = Matrix2x3<double>::toNativeArray(mat);
        auto _mat = std::make_shared<Matrix2x3<double>>(this->sub(xmat));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(this->multiply(i));
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(this->clone());
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(this->transpose());
    ...
    {
        auto mat = std::make_shared<Matrix2x3<double>>(this->transpose3x3());
    ...
    {
        auto _a = Matrix2x3<double>::toNative(a);
        auto _b = Matrix2x3<double>::toNative(b);

        auto mat = std::make_shared<Matrix2x3<double>>(Matrix2x3<double>::linearInterpolate(_a, _b, prop));
    ...
    inline std::shared_ptr<Matrix2x3> toNative(const std::shared_ptr<::JavascriptArray> &arr)
    {
        Kore::Matrix<2U, 3U, T> *nMat = this;
        ...
        return std::make_shared<Matrix2x3>(static_cast<Matrix2x3 *>(nMat));
    }
};
