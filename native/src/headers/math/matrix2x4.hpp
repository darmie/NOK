...
{
template <class T>
class Matrix2x4 : public nok::Mat2, public Kore::Matrix<2U, 4U, T>
{
public:
    Matrix2x4() : nok::Mat2(), Kore::Matrix<2U, 4U, T>(){};
    Matrix2x4(Matrix2x4 *mat) : nok::Mat2(), Kore::Matrix<2U, 4U, T>(*static_cast<Matrix2x4 *>(mat)){};
    ~Matrix2x4(){};
